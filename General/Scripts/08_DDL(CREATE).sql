 ...
 * 이름					: 	MEMBER_NAME		VARCHAR(15) (한글 5글자까지)
...
INSERT INTO "MEMBER" 
VALUES('MEM01', '123ABC', '홍길동', '990266-1234567', SYSDATE);
...
-- 가입일 -> SYSDATE를 활용
INSERT INTO "MEMBER" 
VALUES('MEM02', 'qwer1234', '김미영', '981234-4234567', SYSDATE);

-- 가입일 -> DEFAULT 활용(테이블 생성 시 정의된 값이 반영됨)
INSERT INTO "MEMBER" 
VALUES('MEM03', '1Q2W3Er', '박철수', '912345-4234527', DEFAULT);
...
VALUES
('MEM04', 'QQQQ2222','신짱구','021245-2124567');
...
/* CREATE TABLE 수행 시 제약 조건을 설정하는 방법
 * 
 * 1) 컬럼 레벨 설정 : 테이블 컬럼을 선언할 때 제약조건 추가
 * 	컬럼명 자료형 [CONSTRAINT 제약조건명] 제약조건
 * 
 * 2) 테이블 레벨 설정 : 테이블 생성 구문 제일 밑에 작성해서 제약 조건 추가
...
--> FOREIGN KEY가 설정된 컬럼의 값은 외부 테이블의 값을 저장할 수 있다
...
WHERE GRADE_CODE = 10;
-- 무결성 제약조건(KH26_CYS.GRADE_CODE_FK1)이 위배되었습니다
-- - 자식 레코드가 발견되었습니다
...
CREATE TABLE USER_USED_FK3(
  ...
  ON DELETE CASCADE	-- 부모행 삭제 시 참조하는 모든 자식 행 삭제
);
...
-- 체크 제약조건(KH26_CYS.CHEKC_SCORE)이 위배되었습니다
...
CREATE TABLE USER_TEST(
	USER_NO VARCHAR(10) 
		CONSTRAINT PK_USER_TEST PRIMARY KEY,
	USER_ID VARCHAR(20) 
...
INSERT INTO USER_TEST VALUES ('U0001', '짱구', 'nohara123', '123456-7890123', '남', '010-1234-5678', '떡잎마을 1번지', 'Y');
INSERT INTO USER_TEST VALUES ('U0002', '철수', 'smartboy', '234567-8901234', '남', '010-2345-6789', '떡잎마을 2번지', 'Y');
INSERT INTO USER_TEST VALUES ('U0003', '유리', 'princess', '345678-9012345', '여', '010-3456-7890', '떡잎마을 3번지', 'Y');
INSERT INTO USER_TEST VALUES ('U0004', '훈이', 'eatlover', '456789-0123456', '남', '010-4567-8901', '떡잎마을 4번지', 'Y');
INSERT INTO USER_TEST VALUES ('U0005', '맹구', 'stonelove', '567890-1234567', '남', '010-5678-9012', '떡잎마을 5번지', 'N');
...
--> 서브쿼리로 테이블 생성 시 
--> 별도의 제약 조건 설정, DEFAULT 설정, COMMENT 설정 등이 필요
